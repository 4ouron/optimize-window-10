...
$essentialtweaks.Add_Click({ 
	...
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/4ouron/optimize-window-10/main/ooshutup10.cfg" -Destination ooshutup10.cfg
...
$Bloatware = @(
        ...
        "Microsoft.WindowsStore_2015.7.1.0_x64__8wekyb3d8acb"
        "Microsoft.YourPhone"
